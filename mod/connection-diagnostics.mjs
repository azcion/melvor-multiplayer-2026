...
const ROUTES = new Set(["/api/installations/enroll", "/api/authenticate", "/api/banishment/returns/acknowledge", "/api/banishment/returns/claim", "/api/campaign/claim", "/api/campaign/contribute", "/api/campaign/info", "/api/charity/contents", "/api/charity/donate", "/api/charity/shuffle", "/api/charity/take", "/api/chat/block", "/api/chat/conversations", "/api/chat/conversations/delete", "/api/chat/conversations/start", "/api/chat/global-participation", "/api/chat/guild-participation", "/api/chat/messages", "/api/chat/messages/delete", "/api/chat/messages/send", "/api/chat/privacy", "/api/chat/state", "/api/client/active-mods/visibility", "/api/client/activity/visibility", "/api/client/equipment/sync", "/api/client/equipment/visibility", "/api/client/game-mode/visibility", "/api/client/gp/visibility", "/api/client/icon-catalog/check", "/api/client/icon-catalog/upload", "/api/client/set_display_name", "/api/client/set_icon", "/api/client/skills/visibility", "/api/client/status/sync", "/api/client/status/visibility", "/api/economy/receipts/acknowledge", "/api/events", "/api/friends/accept", "/api/friends/add", "/api/friends/get", "/api/friends/ignore", "/api/friends/remove", "/api/gift/accept", "/api/gift/decline", "/api/gift/discard", "/api/gift/send", "/api/guilds/active-mods", "/api/guilds/activity", "/api/guilds/application/decide", "/api/guilds/apply", "/api/guilds/council", "/api/guilds/create", "/api/guilds/equipment", "/api/guilds/join", "/api/guilds/join-free", "/api/guilds/leave", "/api/guilds/list", "/api/guilds/members", "/api/guilds/members/shadowed", "/api/guilds/petitions/raise", "/api/guilds/petitions/vote", "/api/guilds/petitions/withdraw", "/api/guilds/state", "/api/guilds/status", "/api/guilds/withdraw", "/api/identities", "/api/identities/delete", "/api/identities/delete/cancel", "/api/inbox", "/api/inbox/acknowledge", "/api/inbox/claim", "/api/market/buy", "/api/market/buy-order", "/api/market/cancel", "/api/market/catalog", "/api/market/destroy", "/api/market/fulfill", "/api/market/listings", "/api/market/payout", "/api/market/search", "/api/market/sell", "/api/raids/activate", "/api/raids/assaults/abandon", "/api/raids/assaults/reserve", "/api/raids/assaults/settle", "/api/raids/cache", "/api/raids/cache/acknowledge", "/api/raids/state", "/api/register", "/api/social-mode/cancel", "/api/trade/accept", "/api/trade/cancel", "/api/trade/counter", "/api/trade/decline", "/api/trade/offer", "/api/trade/resolve", "/api/transfers/get_contents"]);
ROUTES.add('/api/social-mode/set');
ROUTES.add('/api/market/claim-legacy-payouts');
ROUTES.add('/api/charity/wish/forsake');
