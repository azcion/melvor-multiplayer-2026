...
test('keeps revision triggers for every database-backed event snapshot source', () => {
	...
	for (const name of [
		...
		'event_global_chat_message_insert', 'event_global_chat_read_insert', 'event_global_chat_read_update',
		'event_global_chat_moderation_insert', 'event_global_chat_participation_update',
