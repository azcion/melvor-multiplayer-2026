...
describe('SQLite persistence probe', () => {
	test('initializes every application table', async () => {
		...
		expect(tables).toEqual([
			...
			'charity_items',
			'charity_shuffle_events',
			'charity_shuffles',
			'charity_wish_commands',
			'charity_wishes',
			'chat_blocks',
			'chat_conversations',
			'chat_message_bodies',
			...
			'gift_items',
			'gifts',
			'global_chat_client_throttles',
			'global_chat_message_moderation',
			'global_chat_message_reactions',
			'global_chat_messages',
			'global_chat_read_state',
			'global_chat_server_throttle',
			'gp_snapshots',
			'guild_activity_events',
			'guild_applications',
			'guild_chat_message_moderation',
			'guild_chat_message_reactions',
			'guild_chat_messages',
			'guild_chat_read_state',
			'guild_memberships',
			'guild_petition_charity_wishes',
			...
			'support_team_welcome_localizations',
			'support_teams',
